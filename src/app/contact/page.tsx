                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">123 Solar Street, Sun Valley, Manila, Philippines</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">+63 2 8123 4567</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">info@8gpi.com</p>
                      <p className="text-gray-600">support@8gpi.com</p>
                    </div>
                  </div>
